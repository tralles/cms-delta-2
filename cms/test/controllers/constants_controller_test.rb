...
class ConstantsControllerTest < ActionController::TestCase
  ...
  test "should create constant" do
    assert_difference('Constant.count') do
      post :create, constant: { category: @constant.category, name: @constant.name, type: @constant.type, value: @constant.value }
    end
  ...
  test "should update constant" do
    patch :update, id: @constant, constant: { category: @constant.category, name: @constant.name, type: @constant.type, value: @constant.value }
    assert_redirected_to constant_path(assigns(:constant))
  end
