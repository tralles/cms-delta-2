...
class ContentTypesControllerTest < ActionController::TestCase
  ...
  test "should create content_type" do
    assert_difference('ContentType.count') do
      post :create, content_type: { editor: @content_type.editor, intern: @content_type.intern, name: @content_type.name, project_id: @content_type.project_id, ref_id: @content_type.ref_id }
    end
  ...
  test "should update content_type" do
    patch :update, id: @content_type, content_type: { editor: @content_type.editor, intern: @content_type.intern, name: @content_type.name, project_id: @content_type.project_id, ref_id: @content_type.ref_id }
    assert_redirected_to content_type_path(assigns(:content_type))
  end
