...
class WorkspacesControllerTest < ActionController::TestCase
  ...
  test "should create workspace" do
    assert_difference('Workspace.count') do
      post :create, workspace: { intern: @workspace.intern, name: @workspace.name, project_id: @workspace.project_id }
    end
  ...
  test "should update workspace" do
    patch :update, id: @workspace, workspace: { intern: @workspace.intern, name: @workspace.name, project_id: @workspace.project_id }
    assert_redirected_to workspace_path(assigns(:workspace))
  end
