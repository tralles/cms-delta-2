...
class BranchesControllerTest < ActionController::TestCase
  ...
  test "should create branch" do
    assert_difference('Branch.count') do
      post :create, branch: { hidden: @branch.hidden, name: @branch.name, position: @branch.position, project_id: @branch.project_id, ref_id: @branch.ref_id }
    end
  ...
  test "should update branch" do
    patch :update, id: @branch, branch: { hidden: @branch.hidden, name: @branch.name, position: @branch.position, project_id: @branch.project_id, ref_id: @branch.ref_id }
    assert_redirected_to branch_path(assigns(:branch))
  end
