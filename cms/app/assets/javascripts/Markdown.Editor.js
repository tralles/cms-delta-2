...
(function () {
	...
	var defaultHelpHoverTitle = "Markdown Cheatsheet";
	...
	ui.prompt = function (title, text, defaultInputText, callback) {
		...
		var createDialog = function () {
			...
			okButton.className = "btn btn-mini btn-primary";
			...
			cancelButton.className = "btn btn-mini btn-primary";
	...
	function UIManager(postfix, panels, undoManager, previewManager, commandManager, helpOptions) {
		...
		function makeSpritedButtonRow() {
			...
			group3 = makeGroup(3);
			buttons.quote = makeButton("wmd-quote-button", "Blockquote - Ctrl+Q", "fa fa-quote-left", bindCommand("doBlockquote"), group3);
			...
			group4 = makeGroup(4);
			buttons.hr = makeButton("wmd-hr-button", "Horizontal Rule - Ctrl+R", "fa fa-ellipsis-h", bindCommand("doHorizontalRule"), group4);
			...
			buttons.redo = makeButton("wmd-redo-button", redoTitle, "fa fa-rotate-right", null, group5);
			buttons.redo.execute = function (manager) { if (manager) manager.redo(); };

			if (helpOptions) {
				group10 = makeGroup(10);
				group10.className = group10.className + " pull-right";
				var helpButton = document.createElement("button");
				var helpButtonImage = document.createElement("i");
				helpButtonImage.className = "fa fa-question";
				helpButton.appendChild(helpButtonImage);
				helpButton.className = "btn btn-mini";
				...
				group10.appendChild(helpButton);
