 ...
 * https://github.com/ifad/data-confirm-modal/blob/master/vendor/assets/javascripts/data-confirm-modal.js
 */
(function ($) {
  ...
  var buildModal = function (element) {
    ...
    var modal = $('\
      <div id="'+id+'" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="'+id+'Label" aria-hidden="true"> \
        ...
        <div class="modal-footer"> \
          ...
          <button class="btn btn-inverse" data-dismiss="modal" aria-hidden="true">Abbrechen</button> \
        </div> \
      </div>');
    ...
    commit.text(element.data('commit') || 'OK');
