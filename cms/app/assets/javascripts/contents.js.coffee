    ...
    if $('#docpoover')
      if $("textarea.inline_documents").length > 0 
        ...
        $("textarea.inline_documents").each (index) ->
          ...
          $(this).after "<div class=\"documentactions\"><span class=\"documentaction btn btn-mini btn-info\" rel=\"" + $(this).attr("id") + "\"><i class=\"fa fa-picture-o\" /> Dokumente</span></div>"  if $("#docpoover .line").length > 0
